  ...
  return (
    <>
      ...
      <p className="justified">
        {capitalizedRole} skilled in creative problem solving, with a background
        in English Education, high quality customer service, and music
        production and performance. Avid about lifelong learning and applying
        knowledge of best practices in web development. Recently completed
        Auburn University's Software Engineering Bootcamp. Looking for
        challenging roles to apply and broaden my knowledge base
      </p>
        ...
        <div className="harris">
          ...
          <ul>
            ...
            <li>
              ...
              technologies and techniques to keep classes of 35+ students
              on task, engaged, and ready for daily assessments and annual End
              of Course Tests.
            </li>
            <li>
